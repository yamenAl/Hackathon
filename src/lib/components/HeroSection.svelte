...
<div class="hero">
  ...
  <!-- ── Hero content overlay ──────────────────────────────────
       Main cinematic title shown above the video background.
       Kept centered and readable with subtle glow and overlay.
       --------------------------------------------------------- -->
  <div class="hero__content">
    <p class="hero__eyebrow">Mission Interface</p>

    <h1 class="hero__title">
      <span class="hero__title-main">NEBULA</span>
      <span class="hero__title-separator">—</span>
      <span class="hero__title-sub">Xplorer</span>
    </h1>

    <p class="hero__description">
      Journey into the black hole and uncover the Nebula Xplorer mission.
    </p>
  </div>
...
<style>
  ...
  /* ── Readability overlay ─────────────────────────────────────
     Subtle dark layer above the video, below the title content.
     Keeps hero text readable without killing the cinematic feel.
  ── */
  .hero::after {
    content: '';
    position: absolute;
  ...
  .hero__eyebrow {
    ...
    text-shadow: 0 0 12px rgba(128, 96, 255, 0.22);
  }
  ...
  .hero__title-separator {
    ...
    color: #f3efff;
    text-shadow:
      0 0 12px rgba(128, 96, 255, 0.3),
      0 0 30px rgba(128, 96, 255, 0.18),
      0 0 60px rgba(128, 96, 255, 0.12);
  }
  ...
  /* ── Small screens: stack title for better balance ────────── */
